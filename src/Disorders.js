...
function Disorder() {
  ...
  return (
     <div class="container">
        <h1>Child Behavior Disorders</h1>
        <p>Here is some information about various child behavior disorders:</p>
        <ul>
            ...
            <p style={stlyetag}><strong>Treatment<br /></strong>
            ...
            <li><strong>Conduct Disorder (CD)</strong></li>
            <p style={stlyetag}>
            ...
            <li><strong>ADHD - Attention-Deficit/Hyperactivity Disorder</strong></li>
            <p style={stlyetag}>
                ADHD is one of the most common neurodevelopmental disorders of childhood. It is usually first diagnosed in childhood and often lasts into adulthood. Children with ADHD may have trouble paying attention, controlling impulsive behaviors (may act without thinking about what the result will be), or be overly active.<br />


            </p>
            <p style={stlyetag}><strong>Treatment</strong><br />
            ...
            <li><strong>Tourette Syndrome (TS)</strong></li>
            <p style={stlyetag}>
